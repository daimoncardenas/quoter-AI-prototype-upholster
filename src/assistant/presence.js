 ...
 *
 * Vive en src/assistant/presence.js (corte 5) y viaja en el paquete de src/ como un módulo más,
 * envuelto en `empezarLaPresencia()`: la página lo ARRANCA al final, después del script del
 * cotizador — el mismo momento y el mismo aislamiento que antes (era un <script type="module">
 * aparte), ahora con su `'use strict'` explícito. Los modelos 3D siguen viniendo embebidos como
 * JSON (`<script type="application/json" id="assistantModel-*">`).
...
export async function empezarLaPresencia() {
  'use strict';
