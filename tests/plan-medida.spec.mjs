...
/* Los precios ya no rotulan el IVA junto a la cifra (dueño, 23/09): la pantalla muestra la cifra y su periodo. */
check('el total de la pantalla es el de Store.myAci()',
  totalUI, totalEsperado.replace(/\s+/g,' ').trim());
